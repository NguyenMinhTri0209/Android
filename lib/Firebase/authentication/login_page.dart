...
import 'package:listview/Firebase/authentication/authentication_methods.dart';
import 'package:listview/Firebase/authentication/register_page.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

import 'package:listview/Firebase/helpers/checks.dart';
                      ...
                      if(validate == true){
                        ...
                        then((value){
                          Navigator.of(context).pushAndRemoveUntil(
                              MaterialPageRoute(builder: (context) => const MyFirebaseApp(),)
                              , (route) => false);
